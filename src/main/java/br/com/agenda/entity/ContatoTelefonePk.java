...
public class ContatoTelefonePk implements Serializable {
	...
	@ManyToOne(cascade = CascadeType.PERSIST, fetch = FetchType.LAZY, targetEntity = Contato.class)
	private Contato contato;

	@ManyToOne(cascade = CascadeType.PERSIST, fetch = FetchType.LAZY, targetEntity = Telefone.class)
